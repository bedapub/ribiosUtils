...
#if (BIOS_PLATFORM == BIOS_PLATFORM_IRIX) || (BIOS_PLATFORM == BIOS_PLATFORM_SOLARIS) || (BIOS_PLATFORM == BIOS_PLATFORM_LINUX) || (BIOS_PLATFORM == BIOS_PLATFORM_MACOS)
...
#if (BIOS_PLATFORM == BIOS_PLATFORM_LINUX) || (BIOS_PLATFORM == BIOS_PLATFORM_MACOS)
#define PLABLA_FLOCK_OPENFFLAG O_RDONLY
#define PLABLA_FLOCK(fildes) flock(fildes,LOCK_EX)
#define PLABLA_FLOCKNB(fildes) flock(fildes,LOCK_EX|LOCK_NB)
#define PLABLA_FUNLOCK(fildes) flock(fildes,LOCK_UN)
